...
exports.DirBuilder = exports.CodeBuilder = exports.CodeBuffer = exports.t = exports.dts = exports.all = exports.r = exports.js = exports.ts = exports.f = void 0;
...
class BuilderImportsExports {
    ...
    addImport(names, fromPath, allowFileExt = false, modes, typeOnly = false) {
        this.imports.add({
            type: "partial",
            fromPath,
            names,
    ...
    addDefaultImport(name, fromPath, allowFileExt = false, modes, typeOnly = false) {
        this.imports.add({
            type: "default",
            fromPath,
            name,
    ...
    addStarImport(name, fromPath, allowFileExt = false, modes, typeOnly = false) {
        this.imports.add({
            type: "star",
            fromPath,
            name,
    ...
    addExportFrom(names, fromPath, allowFileExt = false, modes, typeOnly = false) {
        this.exports.add({
            type: "from",
            names,
            fromPath,
            ...
            switch (imp.type) {
                case "default":
                    ...
                    imports.add(moduleKind === "esm"
                        ? `import${imp.typeOnly ? " type" : ""} ${imp.name} from "${imp.fromPath}${esmFileExt}";`
                ...
                case "star":
                    ...
                    imports.add(moduleKind === "esm"
                        ? `import${imp.typeOnly ? " type" : ""} * as ${imp.name} from "${imp.fromPath}${esmFileExt}";`
                ...
                case "partial":
                    const names = Object.entries(imp.names)
                        ...
                        .join(", ");
                    imports.add(moduleKind === "esm"
                        ? `import${imp.typeOnly ? " type" : ""} { ${names} } from "${imp.fromPath}${esmFileExt}";`
