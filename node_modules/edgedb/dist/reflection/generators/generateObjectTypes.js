    ...
    for (const type of types.values()) {
        if (type.kind !== "object") {
            if (type.kind === "scalar" && ((_a = type.enum_values) === null || _a === void 0 ? void 0 : _a.length)) {
                ...
                if (enumMod === "default") {
                    module.buf.writeln([(0, builders_1.js) `const ${getEnumTypeName(type.name)} = {`], ...type.enum_values.map(val => [
                        (0, builders_1.js) `  ${(0, genutil_1.makePlainIdent)(val)}: ${(0, genutil_1.quote)(val)},`,
                    ]), [(0, builders_1.js) `}`]);
                    ...
                    module.buf.writeln([(0, builders_1.js) `"${getEnumTypeName(type.name)}": {`], ...type.enum_values.map(val => [
                        (0, builders_1.js) `  ${(0, genutil_1.makePlainIdent)(val)}: ${(0, genutil_1.quote)(val)},`,
                    ]), [(0, builders_1.js) `},`]);
                }
            }
