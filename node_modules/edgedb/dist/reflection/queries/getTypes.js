...
exports.topoSort = exports.getTypes = exports.typeMapping = exports.nonCastableTypes = void 0;
const strictMap_1 = require("../strictMap");
exports.nonCastableTypes = new Set([]);
const numberType = {
        ...
        switch (type.kind) {
            case "scalar":
                if (exports.typeMapping.has(type.id)) {
                    type.castOnlyType = exports.typeMapping.get(type.id).id;
                }
                if (type.is_seq) {
