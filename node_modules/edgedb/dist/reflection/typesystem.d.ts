...
export interface ScalarType<Name extends string = string, TsType extends any = any, Castable extends boolean = boolean, TsConstType extends TsType = TsType> extends BaseType {
...
export declare type scalarTypeWithConstructor<S extends ScalarType, ExtraTsTypes extends any = never> = S & {
    <T extends S["__tstype__"] | ExtraTsTypes>(val: T): $expr_Literal<ScalarType<S["__name__"], S["__tstype__"], S["__castable__"], T extends S["__tstype__"] ? T : S["__tstype__"]>>;
};
...
declare type $arrayLikeIndexify<Set extends TypeSet> = Set["__element__"] extends ArrayType | ScalarType<"std::str"> | ScalarType<"std::bytes"> ? {
    [index: number]: $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<getPrimitiveBaseType<Set["__element__"] extends ArrayType ? Set["__element__"]["__element__"] : Set["__element__"]>, Set["__cardinality__"]>>;
    ...
    index<T extends TypeSet<ScalarType<"std::number">> | number>(index: T): $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<getPrimitiveBaseType<Set["__element__"] extends ArrayType ? Set["__element__"]["__element__"] : Set["__element__"]>, cardinalityUtil.multiplyCardinalities<Set["__cardinality__"], T extends TypeSet ? T["__cardinality__"] : Cardinality.One>>>;
...
export declare type getPrimitiveBaseType<T extends BaseType> = T extends ScalarType ? ScalarType<T["__name__"], T["__tstype__"], T["__castable__"]> : T;
...
export declare type CastableScalarType = ScalarType<string, any, true>;
export declare type NonArrayType = ScalarType | EnumType | ObjectType | TupleType | NamedTupleType;
export declare type CastableNonArrayType = CastableScalarType | EnumType | ObjectType | TupleType | NamedTupleType;
export declare type AnyTupleType = TupleType | NamedTupleType;
export declare type CastableArrayType = ArrayType<CastableNonArrayType>;
export declare type unwrapCastableType<T> = T extends CastableArrayType ? ArrayType<unwrapCastableType<T["__element__"]>> : T;
export declare type ParamType = CastableScalarType | ArrayType<CastableScalarType | TupleType<typeutil.tupleOf<ParamType>> | NamedTupleType<{
    [k: string]: ParamType;
