...
import { parseConnectArguments, } from "./conUtils";
...
export class ClientConnectionHolder {
    ...
    get options() {
        var _a;
        return (_a = this._options) !== null && _a !== void 0 ? _a : Options.defaults();
    }
    ...
    async execute(query, args) {
        return this.retryingFetch(query, args, OutputFormat.NONE, Cardinality.NO_RESULT);
    }
    async query(query, args) {
        return this.retryingFetch(query, args, OutputFormat.BINARY, Cardinality.MANY);
    }
    ...
    async querySingle(query, args) {
        return this.retryingFetch(query, args, OutputFormat.BINARY, Cardinality.AT_MOST_ONE);
    }
    async querySingleJSON(query, args) {
        return this.retryingFetch(query, args, OutputFormat.JSON, Cardinality.AT_MOST_ONE);
    }
    async queryRequiredSingle(query, args) {
        return this.retryingFetch(query, args, OutputFormat.BINARY, Cardinality.ONE);
    }
...
class ClientPool {
    ...
    _getNormalizedConnectConfig() {
        var _a;
        return ((_a = this.__normalizedConnectConfig) !== null && _a !== void 0 ? _a : (this.__normalizedConnectConfig = parseConnectArguments(this._connectConfig)));
    }
...
export class Client {
    ...
    static create(dsn, options) {
        return new Client(new ClientPool(dsn, options !== null && options !== void 0 ? options : {}), Options.defaults());
    }
